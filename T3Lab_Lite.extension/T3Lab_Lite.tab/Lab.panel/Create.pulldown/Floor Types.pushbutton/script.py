...
"""--------------------------------------------------"""
# ** use namedtuple to manage data: walltype= namedtuple("walltype",["name","function","layer","fire_rate"]
#                                     layer   = namedtuple("layer",["function","material","thickness")
...
t = Transaction(doc, "Create Floor Type")
t.Start()
