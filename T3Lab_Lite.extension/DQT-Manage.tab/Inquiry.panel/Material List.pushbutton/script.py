...
class MaterialItem(INotifyPropertyChanged):
    ...
    def __init__(self, material):
        ...
        self._id = material.Id.IntegerValue
        ...
        try:
            ...
            self._color_brush = SolidColorBrush(Color.FromRgb(color.Red, color.Green, color.Blue))
        except:
            self._color = "N/A"
...
def calculate_material_usage(doc, material_items):
    """Calculate usage for materials by counting element types that use each material"""
        ...
        for elem_type in type_collector:
            try:
                ...
                if mat_param:
                    ...
                    if mat_id_value and mat_id_value.IntegerValue > 0:
                        mat_id = mat_id_value.IntegerValue
                        
                        if mat_id in material_lookup:
                            if mat_id not in usage_dict:
                                usage_dict[mat_id] = 0
                            usage_dict[mat_id] += 1
            except:
                pass
...
class BatchRenameDialog(Window):
    ...
    def _on_apply(self, sender, args):
        ...
        t = DB.Transaction(doc, "Batch Rename Materials")
        t.Start()
...
class MaterialManagerWindow(Window):
    ...
    def _create_header(self):
        ...
        title = TextBlock()
        title.Text = "Material Manager v1.0"
        title.FontSize = 17
        title.FontWeight = FontWeights.Bold
        panel.Children.Add(title)
    ...
    def _create_tips(self):
        ...
        tips = TextBlock()
        tips.Text = "Deleting materials in use may affect existing elements | Use Batch Rename for multiple materials"
        tips.FontSize = 10
    ...
    def _on_rename(self, sender, args):
        ...
        t = DB.Transaction(doc, "Rename Material")
        t.Start()
    ...
    def _on_duplicate(self, sender, args):
        ...
        for item in selected:
            ...
            t = DB.Transaction(doc, "Duplicate Material")
            t.Start()
    ...
    def _on_delete(self, sender, args):
        ...
        t = DB.Transaction(doc, "Delete Materials")
        t.Start()
