...
class TextNoteTypeItem(INotifyPropertyChanged):
    """Wrapper class for Text Note Type with WPF binding support"""
    ...
    def __init__(self, text_type):
        ...
        self._id = text_type.Id.IntegerValue
    ...
    try:
        ...
        for text_note in collector:
            try:
                ...
                if type_id and type_id.IntegerValue in type_lookup:
                    type_lookup[type_id.IntegerValue].usage_count += 1
            except:
                pass
...
class BatchRenameDialog(Window):
    ...
    def _on_apply(self, sender, args):
        ...
        t = DB.Transaction(doc, "Batch Rename Text Note Types")
        t.Start()
...
class TextNoteTypeManagerWindow(Window):
    ...
    def _create_datagrid(self):
        ...
        col_size.Binding = Binding("text_size")
    ...
    def _on_rename(self, sender, args):
        ...
        t = DB.Transaction(doc, "Rename Text Note Type")
        t.Start()
    ...
    def _on_duplicate(self, sender, args):
        ...
        t = DB.Transaction(doc, "Duplicate Text Note Types")
        t.Start()
        ...
        try:
            ...
            for item in selected:
                try:
                    new_id = item.text_type.Duplicate("Copy of " + item.name)
                    if new_id != DB.ElementId.InvalidElementId:
                        success_count += 1
                except:
                    pass
    ...
    def _on_delete(self, sender, args):
        ...
        t = DB.Transaction(doc, "Delete Text Note Types")
        t.Start()
