...
<Window
    ...
    <Grid>
        ...
        <Border Grid.Row="0" Background="#0F172A" Padding="16,12">
            <StackPanel>
                ...
                <TextBlock Text="Check and auto-tag untagged elements in current view"
                           FontSize="11" Foreground="#FFFFFF" Margin="0,2,0,0"/>
            </StackPanel>
        </Border>
                    ...
                    <StackPanel>
                        ...
                        <StackPanel Orientation="Horizontal">
                            ...
                            <TextBox x:Name="tbMaxDist" Text="3000"
                                     ...
                                     FontSize="12" BorderBrush="#CBD5E1"/>
                        </StackPanel>
                    </StackPanel>
                </Border>
                ...
                <Border x:Name="borderResults" Style="{StaticResource CardBorder}"
                    ...
                    <StackPanel>
                        ...
                        <Grid Height="24" Margin="0,4,0,8">
                            <Border Background="#E0D5C0" CornerRadius="6"/>
                            <Border x:Name="borderProgress"
                                    Background="#6BBF59" CornerRadius="6"
        ...
        <!-- FOOTER -->
        <Border Grid.Row="2" Background="#0F172A" Padding="12,8">
            <TextBlock Text="Copyright by Dang Quoc Truong - DQT (c) 2026"
                       FontSize="10" Foreground="#FFFFFF"
                       HorizontalAlignment="Center"/>
        </Border>
    </Grid>
</Window>
