...
# ==============================================================================
CLR_HEADER      = "#0F172A"   # Gold header bg
CLR_HEADER_TEXT = "#0F172A"   # Dark text on gold
CLR_HEADER_SUB  = "#475569"   # Subtitle
CLR_ACCENT      = "#5D4E37"   # DQT brown accent
CLR_BG          = "#F8FAFC"   # Cream background
CLR_WHITE       = "#FFFFFF"
CLR_BORDER      = "#CBD5E1"   # Gold border
