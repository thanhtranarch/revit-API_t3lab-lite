...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid Margin="15">
        ...
        <!-- Header -->
        <Border Grid.Row="0" Background="#0F172A" CornerRadius="6" Padding="15,12" Margin="0,0,0,12">
            <Grid>
        ...
        <Grid Grid.Row="1" Margin="0,0,0,12">
            ...
            <Border Grid.Column="0" Background="White" BorderBrush="#CBD5E1" BorderThickness="1" CornerRadius="6" Padding="12,8" Margin="0,0,5,0">
                <StackPanel>
            ...
            <Border Grid.Column="1" Background="White" BorderBrush="#CBD5E1" BorderThickness="1" CornerRadius="6" Padding="12,8" Margin="5,0">
                <StackPanel>
            ...
            <Border Grid.Column="2" Background="White" BorderBrush="#CBD5E1" BorderThickness="1" CornerRadius="6" Padding="12,8" Margin="5,0">
                <StackPanel>
                    <TextBlock Text="CATEGORIES" FontSize="9" Foreground="#666" FontWeight="SemiBold"/>
                    <TextBlock x:Name="txtCategories" Text="0" FontSize="24" FontWeight="Bold" Foreground="#10B981"/>
                </StackPanel>
            </Border>
            
            <Border Grid.Column="3" Background="White" BorderBrush="#CBD5E1" BorderThickness="1" CornerRadius="6" Padding="12,8" Margin="5,0,0,0">
                <StackPanel>
        ...
        <Grid Grid.Row="2">
            ...
            <!-- Left Panel - Filters -->
            <Border Grid.Column="0" Background="White" BorderBrush="#CBD5E1" BorderThickness="1" CornerRadius="6" Padding="10" Margin="0,0,10,0">
                <Grid>
                    <Grid.RowDefinitions>
        ...
        <!-- Action Buttons -->
        <Border Grid.Row="3" Background="White" BorderBrush="#CBD5E1" BorderThickness="1" CornerRadius="6" Padding="10" Margin="0,12,0,0">
            <Grid>
                <Grid.ColumnDefinitions>
                    <ColumnDefinition Width="Auto"/>
                    <ColumnDefinition Width="*"/>
