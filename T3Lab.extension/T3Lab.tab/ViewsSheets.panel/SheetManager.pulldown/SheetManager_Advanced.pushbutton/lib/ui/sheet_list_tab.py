...
class SheetListTab(object):
    ...
    def _create_header(self):
        ...
        border = Border()
        border.Background = SolidColorBrush(Color.FromArgb(255, 240, 204, 136))  # #0F172A
    ...
    def _create_summary_cards(self):
        ...
        # Card 3: Categories
        card3, self.txt_categories = self._create_card("CATEGORIES", "0", 2, "#10B981")
        Grid.SetColumn(card3, 2)
        grid.Children.Add(card3)
        
        # Card 4: Filters
        card4, txt_filters = self._create_card("FILTERS", "Active", 3, "#475569")
    ...
    def _create_card(self, label, value, margin_index, value_color=None):
        ...
        border.BorderBrush = SolidColorBrush(Color.FromArgb(255, 212, 184, 122))  # #CBD5E1
    ...
    def _create_datagrid(self):
        ...
        grid.AlternatingRowBackground = SolidColorBrush(Color.FromArgb(255, 255, 253, 245))  # #F1F5F9
    ...
    def _create_action_buttons(self):
        ...
        # Create buttons
        primary_color = SolidColorBrush(Color.FromArgb(255, 240, 204, 136))  # #0F172A
        white_color = SolidColorBrush(Color.FromArgb(255, 255, 255, 255))
        green_color = SolidColorBrush(Color.FromArgb(255, 76, 175, 80))  # #10B981
