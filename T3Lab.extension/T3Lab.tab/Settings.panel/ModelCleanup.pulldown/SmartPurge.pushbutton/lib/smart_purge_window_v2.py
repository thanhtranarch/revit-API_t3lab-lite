...
class SmartPurgeWindowV2(Window):
    ...
    def action_panel(self, row):
        ...
        copyright.Foreground = SolidColorBrush(self.parse_color("#FF94A3B8"))
    ...
    def create_category_row(self, cat):
        ...
        count.Foreground = SolidColorBrush(self.parse_color("#FF94A3B8"))
        ...
        safety.Foreground = SolidColorBrush(
            self.parse_color("#FF10B981" if cat.is_safe() else "#FFFFC107")
        )
        ...
        try:
            ...
            if label:
                if cat.unused_count > 0:
                    ...
                    label.Text = "(0)"
                    label.Foreground = SolidColorBrush(self.parse_color("#FF94A3B8"))
