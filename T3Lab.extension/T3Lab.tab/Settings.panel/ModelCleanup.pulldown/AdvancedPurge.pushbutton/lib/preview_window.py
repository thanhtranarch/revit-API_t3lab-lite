...
class PreviewWindow(Window):
    ...
    def header_panel(self, row):
        ...
        count.FontSize = 12
        count.Foreground = SolidColorBrush(self.parse_color("#FF475569"))
    ...
    def action_panel(self, row):
        ...
        info.Foreground = SolidColorBrush(self.parse_color("#FF475569"))
        ...
        btn_export.Background = SolidColorBrush(self.parse_color("#FF10B981"))
