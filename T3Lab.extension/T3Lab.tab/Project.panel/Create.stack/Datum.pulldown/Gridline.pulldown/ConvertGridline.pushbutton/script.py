        ...
        <Border Grid.Row="1" Background="White" BorderBrush="#CBD5E1" BorderThickness="1" CornerRadius="6" Padding="10" Margin="15,10,15,0">
            <Grid>
                ...
                <StackPanel Grid.Column="0" HorizontalAlignment="Center">
                    <TextBlock x:Name="txtTotalGrids" Text="0" FontSize="22" FontWeight="Bold" Foreground="#0F172A" HorizontalAlignment="Center"/>
                ...
                <StackPanel Grid.Column="3" HorizontalAlignment="Center">
                    <TextBlock x:Name="txtSelectedGrids" Text="0" FontSize="22" FontWeight="Bold" Foreground="#F59E0B" HorizontalAlignment="Center"/>
            ...
            <StackPanel>
                ...
                <Grid>
                    <StackPanel Orientation="Horizontal" HorizontalAlignment="Left">
                        ...
                        <Button x:Name="btnBubbleStartOn" Content="&#x25C9; Start ON" Padding="10,5" Margin="2" Background="#E8F5E9" BorderBrush="#10B981" Foreground="#2E7D32" FontWeight="SemiBold" FontSize="11"/>
                        <Button x:Name="btnBubbleStartOff" Content="&#x25CB; Start OFF" Padding="10,5" Margin="2" Background="#FFEBEE" BorderBrush="#EF4444" Foreground="#C62828" FontWeight="SemiBold" FontSize="11"/>
                        <Border BorderBrush="#CBD5E1" BorderThickness="1,0,0,0" Margin="6,2,6,2"/>
                        <Button x:Name="btnBubbleEndOn" Content="&#x25C9; End ON" Padding="10,5" Margin="2" Background="#E8F5E9" BorderBrush="#10B981" Foreground="#2E7D32" FontWeight="SemiBold" FontSize="11"/>
                        <Button x:Name="btnBubbleEndOff" Content="&#x25CB; End OFF" Padding="10,5" Margin="2" Background="#FFEBEE" BorderBrush="#EF4444" Foreground="#C62828" FontWeight="SemiBold" FontSize="11"/>
                        <Border BorderBrush="#CBD5E1" BorderThickness="1,0,0,0" Margin="6,2,6,2"/>
